...
<main class="main-content">
    ...
    <header class="page-header">
        <div>
            ...
            <h1>Stok İadesi</h1>
            <p class="page-description">İade edilecek malzemeyi kaynak raftan hedef depoya aktarın.</p>
        </div>
        <a class="button" href="/stok-takip/public/stock-movements">Hareketlere Dön</a>
    </header>

    <div class="form-panel stock-return-panel">
        <?php if (!empty($error)): ?>
            <div class="error"><?= htmlspecialchars($error) ?></div>
        <?php endif; ?>

        <form method="POST" action="/stok-takip/public/stock/return" class="material-form">
            ...
            <div class="form-grid">
                ...
                <div class="form-field">
                    <label for="source_location_id">İade Kaynak Depo / Raf *</label>
                ...
                <div class="form-field">
                    <label for="target_location_id">İade Hedef Depo / Raf *</label>
            ...
            <div class="form-actions">
                ...
                <button class="button button-primary button-return" type="submit">İadeyi Kaydet</button>
            </div>
        </form>
    </div>
