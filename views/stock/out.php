...
<main class="main-content">
    ...
    <header class="page-header">
        <div>
            ...
            <h1>Stok Çıkışı</h1>
            <p class="page-description">Seçilen depo ve raftan mevcut stok miktarını düşürün.</p>
        </div>
        <a class="button" href="/stok-takip/public/stock-movements">Hareketlere Dön</a>
    </header>

    <div class="form-panel stock-entry-panel">
        <?php if (!empty($error)): ?>
            <div class="error"><?= htmlspecialchars($error) ?></div>
        <?php endif; ?>

        <form method="POST" action="/stok-takip/public/stock/out" class="material-form">
            ...
            <div class="form-actions">
                ...
                <button class="button button-primary button-out" type="submit">Stok Çıkışı Kaydet</button>
            </div>
        </form>
    </div>
