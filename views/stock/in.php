...
<main class="main-content">
    ...
    <header class="page-header">
        <div>
            ...
            <h1>Stok Girişi</h1>
            <p class="page-description">Seçilen depo ve rafa yeni stok miktarı ekleyin.</p>
        </div>
    ...
    <div class="form-panel stock-entry-panel">
        ...
        <form method="POST" action="/stok-takip/public/stock/in" class="material-form">
            ...
            <div class="form-actions">
                ...
                <button class="button button-primary" type="submit">Stok Girişi Kaydet</button>
            </div>
        </form>
    </div>
